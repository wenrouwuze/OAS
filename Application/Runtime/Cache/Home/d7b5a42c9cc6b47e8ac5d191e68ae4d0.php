    ...
    <div class="bottom-panel" style="background-color: #ffffff;padding-top: 20px">
        <div class="nav-box" style="border-bottom: 1px solid #E6E6E6;margin-top: 2%">
            <ul style="padding: 0px; width: 65%;height: 40px">
                ...
                <li class="on-1" style="width: 25%"><a href="<?php echo U('Home/Main/main_employee_formal_half_a_month');?>">半个月内转正的员工</a></li>
                <li class="off-1" style="width: 25%"><a href="<?php echo U('Home/Main/main_employee_end');?>">两个月内合同到期</a></li>
        ...
        <div class="tab" style="margin-top: 20px">
            <table class="table table-responsive" style="border: 1px solid #EEEEEE; min-width: 714px; ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (date('Y-m-d',$val["em_formaltime"])); ?></td>
    ...
    layui.use('laypage', function(){
        ...
        laypage.render({
            ...
            ,jump: function(obj,first){
                if(!first){
                    var url = "<?php echo U('Home/Main/main_employee_formal_half_a_month');?>?p="+obj.curr+'&limit='+obj.limit;
                    window.location.href = url;
                }
            }
        });
